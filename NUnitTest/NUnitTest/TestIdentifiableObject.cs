...
using NUnit.Framework; //Don't forget this. //Rename this to the namespace of your project (project name).
using TestingDemo;

namespace NUnitTest //This should match your NUnit test project name.
{
    [TestFixture]
